...
pocasgui_qt_CXXMODULES:= bqt_eventloop bqt_eventfilter bqt_control bqt_window bqt_label bqt_button
pocasgui_qt_PREPROCMODULES:= bqt_eventloop bqt_eventfilter bqt_control bqt_window bqt_label bqt_button
